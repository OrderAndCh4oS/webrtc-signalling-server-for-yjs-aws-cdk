...
import {CfnApi, CfnAuthorizer, CfnDeployment, CfnIntegration, CfnRoute, CfnStage} from "aws-cdk-lib/aws-apigatewayv2";
import {
    // PolicyDocument,
    // Role,
    ServicePrincipal
...
export class WebsocketApi extends Construct {
    ...
    constructor(
        ...
        this.api = new CfnApi(this, 'WebRtcSignallingServerWebSocketApi', {
            name: props.apiName,
